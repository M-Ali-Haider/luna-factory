...
const Main2 = () => {
  return (
    <div className="flex justify-center bg-primary">
      <ImageBackground />
      <div className="max-w-[1440px] w-full flex flex-col xl:flex-row">
        <div
          ...
          <div className="xl:w-fit xl:self-center">
                ...
                <div className="text-black absolute inset-0 bg-primary/80 opacity-0 group-hover:opacity-80 transition-opacity duration-300">
                  <div className="relative size-full">
                    <div className="text-black absolute top-12 left-4 font-extrabold md:text-lg">
                      ...
                      <div className="-mt-1 font-quador">
                        the source factory
                      </div>
                      <div className="mt-5 text-sm font-medium">
                        <div>We have a professional team.</div>
                        <div className="">
                          You can directly find high-quality
                        </div>
            ...
            <div className="text-7xl md:text-[120px] leading-[1] font-barlow font-extrabold text-end md:mt-18 text-black pr-2">
              <h1 className="text-6xl md:text-[90px] leading-[1] relative">
                Sourcing{" "}
                <RightArrowSVG className="absolute md:left-14 -top-7" />
              </h1>
              <h1>in China</h1>
            </div>
          </div>
...
const ImageBackground = () => (
  <div className="absolute top-[64px] right-0 left-0 h-[calc(100vh-64px)]">
    <div className="relative size-full">
      <Image
        alt=""
        src={"/homepage.png"}
        loading="eager"
        fill
        className="bg-primary hidden sm:block object-center object-contain z-[2]"
        priority
        quality={100}
      />
      <Image
        ...
        loading="eager"
        fill
        className="bg-primary object-contain sm:hidden z-[2]"
        priority
        quality={100}
      />
    </div>
